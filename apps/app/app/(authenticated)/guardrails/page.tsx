    ...
    <div className="flex flex-1 flex-col gap-5 p-6">
      ...
      <div>
        ...
        <p className="mt-1 max-w-xl text-muted-foreground text-sm">
          Organization-wide controls for {organization.name}. These override
          every site schedule and every run in flight.
        </p>
      </div>
          ...
          >
            ...
            <div className="flex items-start gap-4 border-foreground border-b-[3px] px-5 py-4">
              <div className="flex-1">
                ...
                <p className="mt-1 max-w-md text-muted-foreground text-xs">
                  Every finished draft stops at an approval gate and waits for a
                  person. Turn this off and the agent publishes on its own,
                  which is faster and riskier.
                </p>
              </div>
              <input
            ...
            <div className="flex items-start gap-4 border-foreground border-b-[3px] px-5 py-4">
              <div className="flex-1">
                ...
                <p className="mt-1 max-w-md text-muted-foreground text-xs">
                  When publishing fails three times in a row the site is paused
                  automatically. This guardrail is always on and cannot be
                  turned off.
                </p>
              </div>
              <input
            ...
            <div className="bg-muted px-5 py-4">
              ...
              <p className="mb-3 max-w-md text-muted-foreground text-xs">
                ...
                hit, runs are skipped for that day and the dispatcher moves on
                rather than queuing a backlog.
              </p>
              <div className="grid grid-cols-2 gap-3">
                <div className="flex flex-col gap-1.5">
                  <Label
                    className="font-bold text-[10.5px] text-muted-foreground uppercase tracking-wider"
                    htmlFor="max_posts_per_day"
                  >
                    Max posts / day
                  </Label>
                  <Input
