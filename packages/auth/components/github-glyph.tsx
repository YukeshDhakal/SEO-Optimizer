// Standard GitHub "octocat" mark, inlined for the same reason as
// google-glyph.tsx (no @repo/design-system dependency here, and
// lucide-react has no branded GitHub icon).
